...
import { FilePlus, Users, BarChart, BookOpen } from 'lucide-react';
        ...
        <div className="p-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Manage tests and student uploads for your course
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => window.location.href = '/course-admin/tests'}
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-blue-600">Create and manage tests for your course</p>
                </div>
              </motion.button>
              ...
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                onClick={() => window.location.href = '/course-admin/student-upload'}
